...
import { MdOutlineAlarmAdd, MdOutlineRestaurantMenu } from 'react-icons/md';
    ...
    <div className='app__navbar-smallscreen'>
      ...
      {toggleMenu && (
        ...
        <div className='app__navbar-smallscreen_overlay flex__center slide-bottom'>
          <MdOutlineRestaurantMenu fontSizeAdjust={27} className='overlay__close' onClick={() => setToggleMenu(false)} />
